...
postgres=# CREATE USER talent_user WITH PASSWORD 'talent_pass';
CREATE ROLE
postgres=# CREATE DATABASE talent_ai;
CREATE DATABASE

C:\Program Files\PostgreSQL\16\bin>.\psql.exe -U postgres -d talent_ai
Password for user postgres:
talent_ai=# GRANT ALL ON SCHEMA public TO talent_user;
GRANT